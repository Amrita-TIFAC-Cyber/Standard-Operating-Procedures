...
# Standard Operating Procedures - Class Advisors
...
- Collect and maintain:
  ...
  - Admission category / quota (slab details)  
- Submit relevant data for **Program Files (NBA/IQAC documentation)**.
...
- Conduct regular counselling sessions.
- Address:
  - Academic challenges  
  - Behavioral concerns  
...
- Maintain:
  - Class Advisor Notebook (mandatory)  
  - Digital records (MyAmrita updates)  
- Ensure records are:
  - Updated regularly  
