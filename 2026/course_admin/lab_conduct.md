...
9. Evaluation parameters may include:
   ...
   - Output/Results
   - Viva Voce
   - Observation and Record Maintenance
...
13. A **Round Robin Evaluation Method** shall be followed wherever applicable to ensure students are evaluated by different evaluators and receive varied academic perspectives.
...
Failure to adhere to the laboratory conduct procedures may result in:
- Delay in evaluations
- Reassessment requirements
- Academic review by the department
- Corrective actions as deemed necessary by the department

## 6. Recommended Documentation

The following records shall be maintained for every laboratory course:
- Experiment List
- Evaluation Rubrics
- Attendance Records
- Assessment Sheets
